...
Revision ID: b5e1d018a771
Revises: 
Create Date: 2025-09-04 15:46:41.424630
...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('description', sa.String(length=500), nullable=True),
    sa.Column('net_days', sa.Integer(), nullable=False),
    ...
    sa.Column('role_type', sa.Enum('admin', 'manager', 'employee', 'cashier', 'viewer', 'api_user', 'supervisor', 'auditor', 'system', 'user', name='role_type_enum'), server_default='viewer', nullable=False),
