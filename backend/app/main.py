...
routers_config = [
    ...
    (brand.router, "/api/brands", "Brands"),
    (setting.router, "/api/settings", "Settings"),
    (category.router, "/api/categories", "Categories"),
    (subcategory.router, "/api/subcategories", "SubCategories"),
    (group.router, "/api/groups", "Groups"),
    (subgroup.router, "/api/subgroups", "SubGroups"),
    (unit.router, "/api/units", "Units"),
    (account.router, "/api/accounts", "Accounts"),
    (concept.router, "/api/concepts", "Concepts"),
    (document.router, "/api/documents", "Documents"),
    (country.router, "/api/countries", "Countries"),
    (division.router, "/api/divisions", "Divisions"),
    (municipality.router, "/api/municipalities", "Municipalities"),
    (product.router, "/api/products", "Products"),
    (warehouse.router, "/api/warehouses", "Warehouses"),
    (third_party.router, "/api/third-parties", "ThirdParties"),
    (entry.router, "/api/entries", "Entries"),
    (purchase.router, "/api/purchases", "Purchases"),
    (payment_term.router, "/api/paymentterms", "PaymentTerms"),
    (role.router, "/api/roles", "Roles")
]
