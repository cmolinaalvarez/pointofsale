...
from sqlalchemy import Boolean, Numeric, DateTime, String, ForeignKey, UniqueConstraint, Date
...
class Purchase(Base):
    ...
    purchase_number: Mapped[str] = mapped_column(String(20), index=True, nullable=False)  # Ej: ENT-2025-00001
...
class PurchaseItem(Base):
    ...
    __table_args__ = (
        UniqueConstraint("purchase_id", "product_id", name="uix_purchase_product"),
    )
    ...
    expiration: Mapped[date] = mapped_column(Date, nullable=True)
