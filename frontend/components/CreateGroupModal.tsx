...
interface CreateGroupModalProps {
  ...
  onClose: () => void;
  onSave: (data: { code: string; name: string; subcategory_id:string;  description?: string; active: boolean }) => Promise<void> | void;
  saving?: boolean;
}

export const CreateGroupModal: React.FC<CreateGroupModalProps> = ({ open, subCategories = [], onClose,  onSave,   saving = false }) => {
